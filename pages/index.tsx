...
export default function Home() {
  ...
  return (
    <div >
      ...
      <div className="font-sans relative h-[90vh] bg-background-stars bg-cover bg-center bg-no-repeat bg-fixed
    bg-[#070722]">
      <div className="flex flex-col first-letter:
        justify-evenly py-8
         px-8 md:px-16 space-y-4 md:space-y-8
      items-center h-[70vh] md:[75vh] md:flex-row">
      <Image src={image} alt={planet.name}
      ...
      ">
        <h1 className="text-2xl md:text-4xl font-bold tracking-wider text-white">{planet.name.toUpperCase()}</h1>
        <p className="text-white md:text-xl text-sm">{category.content}</p>
        <p className="text-white text-sm">
          Source : <a href={category.source} className="text-purple-600">Wikipedia</a>
        </p>
        <div className="flex md:flex-col self-end
        ...
        ">
          ...
          className=" 
           ...
           transition duration-150 ease-in
           md:border-white
           md:py-4 md:px-10 md:border hover:bg-purple-600 hover:text-white" onClick={() => {
            setImage(planet.images.internal)
            setCategory(planet.structure)}}>Internal Structure</button>
          <button 
